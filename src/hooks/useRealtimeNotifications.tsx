...
export interface Notification {
  id: string;
  type: 'job_assigned' | 'job_status_changed' | 'low_stock' | 'new_job';
  title: string;
  message: string;
  timestamp: Date;
  read: boolean;
        ...
        (payload) => {
          ...
          if (oldJob.status !== newJob.status) {
            ...
            addNotification({
              ...
              data: { jobId: newJob.id, jobNumber: newJob.job_number, status: newJob.status },
            });
          }
      ...
      .on(
        ...
        async (payload) => {
          ...
          addNotification({
            ...
            data: { productId: alert.product_id, currentStock: alert.current_stock },
          });
        }
      )
      .subscribe();
        ...
        (payload) => {
          ...
          if (
            ...
            addNotification({
              ...
              data: { productId: newProduct.id, currentStock: newProduct.stock },
            });
          }
        }
      )
